...
class _MyHomePageState extends State<DownloadPage> {
  bool debug = true;
  ...
  List<Map<String, String>> _videos = [
    {
      'name': 'unknown3',
      'link':
          'https://storage.googleapis.com/storage/v1/b/tonal-baton-245112.appspot.com/o/VID_2021-02-18%2002-15-37.mp4?alt=media'
    },
    {
      'name': 'blackpink',
      'link':
          'https://storage.googleapis.com/storage/v1/b/tonal-baton-245112.appspot.com/o/VID_2021-02-18%2002-00-37.mp4?alt=media'
    },
  ];
  ...
  Future<Null> _prepare() async {
    final files = await _firebaseStorage.ref().list();
    for (Reference file in files.items) {
      _documents.add({'name': file.name, 'link': await file.getDownloadURL()});
    }
