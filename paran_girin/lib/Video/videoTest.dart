    ...
    setState(() {
      ...
      if (sec == 0){
        ...
        Navigator.of(context_temp).push(
            MaterialPageRoute(builder: (context) => Outtro())
        );
      }
    });
  }
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            return Stack(
              children: [
                ...
                // ),
                Container(child: girin_state == false? GirinSpeak() : GirinNod()),
                Positioned(
  ...
  Widget build(BuildContext context){
    return Stack(
      children: [
        ...
        Align(
          child: TextToSpeech(text:"다음에 또 보자.")
        ),
        Align(
            alignment: Alignment.center,
            child: Container(
              ...
              child: Image.asset("assets/avatars/speaking.gif", fit: BoxFit.cover),
            )),
      ],
    );
  }
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            return Stack(
                children:[
                  Align(
                    child:TextToSpeech(text: "나 뿐만 아니라 옆집 토끼아저씨, 앞집 송아지가족, 내 친구 코끼리까지."),
                  ),
                  Align(
                      alignment: Alignment.center,
                      child: Container(
